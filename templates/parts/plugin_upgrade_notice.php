...
<div class="wpnts-upgrade-banner">
	...
	<div class="banner-content">
		...
		<div class="content">
			<h3><?php esc_html_e('Advance Security settings, Emengency Shutdown, User activity and many more premium features are available in ', 'wpnts'); ?> <span><?php esc_html_e('Notifier To Slack Pro', 'wpnts'); ?></span> <?php esc_html_e('plugin 😍', 'wpnts'); ?></h3>
