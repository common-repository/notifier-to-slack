...
<div class="wpnts-ratting-banner">
	<div class="banner-content" data-value="hide_notice">
		...
		<h3 class="rating-heading"><?php esc_html_e('Sounds like ', 'wpnts'); ?><span class="wpnts-plugin-title"><?php esc_html_e('Notifier To Slack', 'wpnts'); ?></span><?php esc_html_e(' is offering you benefit. 🥳', 'wpnts'); ?></h3>

			<p class="review-notice"><?php esc_html_e( "Hey there! You have been using Notifier To Slack for quite some time. Would you consider leaving us a 😍 5-star review? Your feedback will assist us in developing better features and spreading the word.", 'wpnts' ); ?></p>
